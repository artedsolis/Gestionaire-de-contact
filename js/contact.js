...
function decrire() {
  return `${contact.prenom}, ${contact.nom} travaille dans une biblothèque`;
}

console.log(decrire(contact);
    ...
    console.log(options[0]); console.log(options[1]); console.log(options[2]);
